...
public class Library {
    ...
    // Run LibraryTest.java
    //Check the testBorrowItem() test
    //Try borrowing an available book through the library system
    ...
    public List<Item> searchItems(String query) {
        ...
        for (Item item : items.values()) {
            if (item.getTitle().toLowerCase().contains(query.toLowerCase()) ||
                    ...
                    item.getGenre().equalsIgnoreCase(query) ||
    ...
    public boolean borrowItem(String memberId, String itemId) {
        ...
        item.setAvailable(false); // move this line here because we should set false after checking all logic
